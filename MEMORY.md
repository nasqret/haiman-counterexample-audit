...
accepted certificate is
`results/certificates/lemma19_symmetric_multiplicities.json`, generated by
`artifacts/rust/src/bin/plethysm_multiplicity.rs` with dense semistandard-column
weight DP and Weyl character extraction. Its payload SHA-256 is
...
modulo `1000000007`, hence nonzero integer multiplicities. This proves
symmetric-power occurrence, not explicit highest-weight vector construction
and not `J_8` membership.
